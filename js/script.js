...
function change_next_button(){
    ...
    console.log(div_arr);
      ...
      if(state===0){
        ...
        div_arr[state].classList.remove("active_divider");
        div_arr[state].classList.add("inactive_divider");

        div_arr[state+1].classList.remove("inactive_divider");
        console.log(div_arr[state+1].classList);
        div_arr[state+1].classList.add("active_divider");
        console.log(div_arr[state+1].classList);
